...
\begin{tabular}{rl}
\textsc{Web:} & \href{https://adarshpatil.in/timewarp}{https://adarshpatil.in} \hspace{2cm} \textsc{Address:} Cambridge, UK\\
\textsc{email:} & \href{mailto:me@adarshpatil.in}{me@adarshpatil.in},
\href{mailto:adarsh.patil@arm.com}{adarsh.patil@arm.com}, \href{mailto:adarsh.patil@ed.ac.uk}{adarsh.patil@ed.ac.uk}\\
\end{tabular}

%	PERSONAL STATEMENT
\section{Profile summary}
\iffalse
Staff Research Engineer at Arm with 10+ years working on the computer systems architecture; PhD (University of Edinburgh) and MSc (Research, IISc). I currently work on 5–10 year horizon research for memory \& interconnect architecture—CXL-class disaggregation, reliability/RAS, persistency—and shape scale-up/scale-out fabric strategy (UALink, Ultra/scale-up Ethernet, UCIe, co-packaged optics), delivering prototypes, artifacts and roadmap-ready proposals. Previously shipped megawatt-scale VM/container automation (Goldman Sachs) and performance-critical AI/HPC kernels (Intel); peer-recognized impact via publications (ISCA, DSN, ASPLOS workshop, TACO) and service (MICRO \& HPCA PCs, IEEE CAL reviewer, HPCA’24 Web Chair, SIGARCH editor).
\fi

I have pursued research at both target-oriented industry labs and blue-skies academic research.
...
& \textbf{University of Edinburgh}, United Kingdom \qquad \small{[ARM Fellowship]} \\
...
& \textbf{Ramaiah Institute of Technology (MSRIT)}, Bangalore, India\\
...
Dec 2023 - Current & Staff Research Engineer (Oct '25)& \textsc{Arm}, Cambridge, UK\\
& Senior Research Engineer& \\
& \footnotesize{Systems architecture \& technology group} & \\
& &\\
Apr 2023 - Nov 2023 & Postdoctoral Research Associate & \textsc{University of Edinburgh}, UK \\
{\footnotesize(8 months)} & \footnotesize{Algorithms for next generation cloud systems} & \\
& & \\
%------------------------------------------------	
Aug 2017 - Apr 2019 & Research Scientist & \textsc{Intel}, Bangalore, India \\
{\footnotesize(1 year 8 months)} & \footnotesize{HPC Ecosystem and Applications Team} &\\
& & \\
%------------------------------------------------

Jun 2012 - Jul 2014 & Technology Analyst & \textsc{Goldman Sachs}, Bangalore, India \\
%------------------------------------------------
...
Jun 2011 - Aug 2011 & Summer Analyst &\\
%& \footnotesize{Automation workflows for megawatt scale datacenter resource provisioning and error triage} \\
{\footnotesize (2 years 4 months)} & \footnotesize{Core Platforms, Data Center Engineering}&\\ 
%& \\
...
C3PO @ ICS '25 &  Improving compiler support for SIMD offload using Arm Streaming SVE \\
& \\
HCDS @ ASPLOS '24 &  UDON: Offloading to general purpose compute on CXL memory\\
& \\
DSN '23 &  $\bar{A}$pta: Fault-tolerant object-granular CXL disaggregated memory for \newline accelerating FaaS \hfill \href{https://adar.sh/apta}{https://adar.sh/apta}\\
& \\
ISCA '21 & Dv\'e: Improving DRAM Reliability and Performance On-Demand via \newline Coherent Replication \hfill  \href{https://adar.sh/dve}{https://adar.sh/dve}\\
&\\
...
\begin{tabular}{rp{12cm}}
	...
	& \tabitem Validation using platform testing suites – SpecJBB, kmake, blacksholes, \\
	& ~~~~Dhrystone, Whetstone, Hackbench, Disk tests, Network uperf, lat proc \\
	&\\
	& Linux Containers\\
...
\hskip-0.4cm
\begin{tabular}{l}
	\tabitem IEEE Senior Member, December 2025\\
...
\tabitem \textit{Best outgoing achiever} - Dept. of CSE at MSRIT, (2012) \\
...
& \\
\textsc{Hobbies} & \tabitem Avid endurance athlete: 2 full and 18 half marathons, 1 HYROX event\\
& \tabitem Hiking enthusiast - 25 Munros, several Corbetts, coastal and trail walks\\
